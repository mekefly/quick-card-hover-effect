import { fixContent, borderBox, contentBox, auto, fill, maxContent, minContent, available, GlobalCSSValues } from '../../../CSSValue/types';
import { Length } from '../../../CSSValue/length/Lingth';
import { Percentage } from '../../../CSSValue/Percentage';
export declare type HeightValue = GlobalCSSValues | Length | Percentage | borderBox | contentBox | auto | fill | maxContent | minContent | available | fixContent;
