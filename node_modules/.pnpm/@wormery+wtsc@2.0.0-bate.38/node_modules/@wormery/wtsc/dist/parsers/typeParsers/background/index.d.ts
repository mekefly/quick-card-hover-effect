...
export interface BackgroundGloupIntercace<R> {
    ...
    background: Parser<Array<BackgroundAttachmentValue | BackgroundOriginValue | backgroundColorValue | BackgroundImageValue | BackgroundPositionRestValue[any] | BackgroundRepeatRestValue[any] | BackgroundSizeRestValueType[any]>, R>;
}
