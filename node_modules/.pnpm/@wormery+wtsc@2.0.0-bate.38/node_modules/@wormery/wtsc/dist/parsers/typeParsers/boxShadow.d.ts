...
export interface BoxShadowInterface<R> {
     ...
     * @memberof BoxShadowInterface
     */
    boxShadow(offsetX: Length, offsetY: Length, blurRadius: Length, color: CssColor): R;
    /**
     * https://developer.mozilla.org/zh-CN/docs/Web/CSS/box-shadow
     * @author meke
     * @author meke
     ...
     * @memberof BoxShadowInterface
     */
    boxShadow(inset: inset, offsetX: Length, offsetY: Length, blurRadius: Length, color: CssColor): R;
    /**
     * https://developer.mozilla.org/zh-CN/docs/Web/CSS/box-shadow
     * @author meke
     * @param {Length} offsetX
     ...
     * @memberof BoxShadowInterface
     */
    boxShadow(offsetX: Length, offsetY: Length, blurRadius: Length, spreadRadius: Length, color: CssColor): R;
    /**
     * https://developer.mozilla.org/zh-CN/docs/Web/CSS/box-shadow
     * @author meke
     * @param {'inset'} inset
     ...
     * @memberof BoxShadowInterface
     */
    boxShadow(inset: inset, offsetX: Length, offsetY: Length, blurRadius: Length, spreadRadius: Length, color: CssColor): R;
}
export {};
