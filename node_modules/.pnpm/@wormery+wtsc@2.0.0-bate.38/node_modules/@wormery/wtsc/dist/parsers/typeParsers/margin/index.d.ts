...
export * from './margin';
export interface MarginGroupInterface<R> extends MarginInterface<R>, MarginTopInterface<R>, MarginRightInterface<R>, MarginBottomInterface<R>, MarginLeftInterface<R> {
}
