 ...
 * 类唯一辨认属性等于它代表就是这个类
 */
export declare const injectObject: unique symbol;
/**
...
export interface Inject {
    ...
    readonly ownInject: <V = any, IsAssertionExisted extends boolean = false>(injectKey: InjectKey<V, IsAssertionExisted>) => Required<InjectKey<V, IsAssertionExisted>>['value'];
