...
import { ADD, CSSStyle, StyleValue, PseudoClasses, PseudoElements } from './types';
import { SaveFunction } from './saveApi';
import { WTSCStorage } from './storage';
import { InjectKey } from '../inject/injectKey';
import { Inject } from '../inject/inject';
export declare const WTSCObject: unique symbol;
/**
 ...
 * @template _Parsers
 */
export interface WTSC<Options extends WTSCOptions, ParsersInterface> extends Theme<Options>, Inject {
    /**
     * 一个symbol值，表示是一个WTSC
     * @author meke
     * @type {symbol}
     ...
     * @memberof WTSC
     */
    readonly addAny: (key: string, ...rest: StyleValue) => WTSC<Options, ParsersInterface>;
    readonly if: (value: boolean, callback: () => void, els?: () => void) => WTSC<Options, ParsersInterface>;
    /**
     * 干净的清理后的wtsc
     * @author meke
     * @type {WTSC<Options, ParsersInterface>}
     ...
     * @memberof WTSC
     */
    readonly class: (name: string, global?: boolean) => WTSC<Options, ParsersInterface>;
    readonly selector: (name: string, global?: boolean) => WTSC<Options, ParsersInterface>;
    /**
     * 添加伪元素和伪类选择器
     * @author meke
     ...
     * @memberof WTSC
     */
    readonly pseudo: (pseudo: PseudoElements | PseudoClasses) => WTSC<Options, ParsersInterface>;
    /**
     * 现在隔离作用域与box相同
     * @author meke
     * @template T
     ...
     * @return {*}  {T}
     */
    readonly shandbox: <T>(callback: (this: WTSC<Options, ParsersInterface>, wtsc: WTSC<Options, ParsersInterface>) => T) => T;
    /**
     ...
     * @memberof WTSC
     */
    readonly read: (saveKey: InjectKey<WTSCStorage['style']>) => WTSC<Options, ParsersInterface>;
...
//# sourceMappingURL=WTSC.d.ts.map